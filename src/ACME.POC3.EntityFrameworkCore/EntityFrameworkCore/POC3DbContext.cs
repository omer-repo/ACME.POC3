...
public class POC3DbContext :
    AbpDbContext<POC3DbContext>,
    IIdentityDbContext,
    ITenantManagementDbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder builder)
    {
        ...
        //{
        //    b.ToTable(POC3Consts.DbTablePrefix + "YourEntities", POC3Consts.DbSchema);
        ...
        builder.Entity<MasterClient>(b =>
        {
            b.ToTable(POC3Consts.DbTablePrefix + "MasterClients", POC3Consts.DbSchema);
            b.ConfigureByConvention(); 
